...
#CUDA_VISIBLE_DEVICES=2 python train.py --dataset "office_home" --source="Art.txt" --target="Product_partial.txt" --train_dir="/users/leo/Codes/MOCA/data/office_home" --test_dir="/users/leo/Codes/MOCA/data/office_home"  --batch_size 32 --gpu_ids 0
...
#CUDA_VISIBLE_DEVICES=7 python train.py --datasets "office_home" --source="Art.txt" --target="Real_World.txt" --train_dir="/users/leo/Codes/MOCA/data/office_home" --test_dir="/users/leo/Codes/MOCA/data/office_home"  --batch_size 32 --gpu_ids 0
