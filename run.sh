...
#CUDA_VISIBLE_DEVICES=7 python train.py --dataset="office_31" --source="webcam" --target="amazon" --train_dir="/users/leo/Datasets/DA/office31" --test_dir="/users/leo/Datasets/DA/office31_partial"  --batch_size 32 --gpu_ids 0
...
#CUDA_VISIBLE_DEVICES=0 python train.py --dataset="office_31" --source="amazon" --target="dslr" --train_dir="/users/leo/Datasets/DA/office31" --test_dir="/users/leo/Datasets/DA/office31_partial"  --batch_size 32 --gpu_ids 0
...
#CUDA_VISIBLE_DEVICES=1 python train.py  --dataset="office_31" --source="webcam" --target="amazon" --train_dir="/users/leo/Datasets/DA/office31" --test_dir="/users/leo/Datasets/DA/office31"  --batch_size 28 --gpu_ids 0
...
#CUDA_VISIBLE_DEVICES=0 python train.py --dataset "office_home" --source="Clipart.txt" --target="Art.txt" --train_dir="/users/leo/Codes/MOCA/data/office_home" --test_dir="/users/leo/Codes/MOCA/data/office_home"  --batch_size 32 --gpu_ids 0
